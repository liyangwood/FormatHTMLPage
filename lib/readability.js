...
var readability = {
    ...
    init: function() {
        ...
        document.body.insertBefore(innerDiv, document.body.firstChild);
...
timed(function() {
// arrix: this is very slow and I don't need it
if (false) {
...
timed(function() {
        //arrix: we can do this before constructing the DOM which is much faster
        return;
